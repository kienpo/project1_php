            ...
            <div class="container">
                <div class="row" style="margin: 50px auto;">
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" class="mg-btn-op btn btn-primary btn-block">Cập nhật thông tin điểm</button>
                        <a href="?module=scoresheets&action=student_courses" class="mg-btn-op btn btn-success btn-block">Quay lại</a>
                        <hr>
                    </form>
                </div>
            </div>
